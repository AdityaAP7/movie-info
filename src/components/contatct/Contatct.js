      ...
      <Container>
        <div className="content py-5">
          <Row xs={1} md={2} lg={3} className="g-4">
            <Col>
              <a
                href="mailto:Adityapalodkar@gmail.com"
              ...
              >
                ...
                <h5 className="text-white mb-5">Adityapalodkar@gmail.com</h5>
              </a>
            </Col>
            <Col>
              <a
            ...
            <Col>
              ...
              >
                ...
                <h5 className="text-white mb-5">India</h5>
              </a>
            </Col>
          </Row>
        </div>
...
export default Contatct;import React from "react";
import HeaderC from "../header/HeaderC";
import { Col, Container, Row } from "react-bootstrap";
import { BsFillEnvelopeFill, BsFillTelephoneInboundFill } from "react-icons/bs";
import { MdLocationOn } from "react-icons/md";
